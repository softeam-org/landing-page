...
import { NavLinks, NavLinksProps } from "@/app/components/Navbar/NavLinks";
            ...
            <div className={`${styles.container} ${leagueSpartan.className}`}>
                <header className={styles.cabecalho}>
                    <nav className={styles.navbar}>
                        <Link href="/">
                            <img src="/logo-softeam-with-name.svg" alt="Softeam" className={styles.logo} />
                        </Link>
                    ...
                    <div className={styles['conteudo-cabecalho']}>
                        <div className={styles['texto-cabecalho']}>
                            ...
                            <div className={styles.vagaColaborador}>
                                <div className={styles.vC}>15 vagas disponíveis</div>
